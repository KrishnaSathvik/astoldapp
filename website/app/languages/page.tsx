...
export const metadata = pageMetadata({
  ...
  description:
    'Speak naturally across languages without choosing one first. As Told is designed for multilingual voice notes and natural code-switching, with no forced translation.',
  path: '/languages',
});
 ...
 *
 * Cut on 2026-08-29 from four sections and a device to two and none. The device
 * it carried was a note in a particular script — the exact visual this page was
 * rebuilt to stop showing. It has one device again since 2026-09-01, and it is
 * the **recording screen**: a timer, the word Listening, a level meter, and no
 * language control anywhere on it. That is the page's whole claim as a picture,
 * and it cannot be read as a list of which languages are allowed.
 *
    ...
    <>
      ...
      >
        <div className={`reveal ${styles.heroShot}`}>
          <PhoneShot
            ...
            alt="As Told recording: Cancel at the top, an elapsed time of 00:21, the word Listening, a live level meter, and Pause beside a round stop button. Nothing on the screen asks which language is being spoken."
          />
        </div>
      </PageHero>
      ...
      <Section tone="warm">
        <SectionIntro
          ...
          lede="Speech recognition varies. How well it does depends on the language, the accent, the room, the microphone, and how much the languages are mixed — so it is worth saying plainly that this is a capability, not a guarantee. Multilingual and mixed-language voice is tested before every release, and what comes back is your words in the language you used: punctuated and broken into paragraphs, never rewritten and never translated."
          wide
        >
