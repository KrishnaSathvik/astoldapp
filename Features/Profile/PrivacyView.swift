...
struct PrivacyView: View {
    ...
    private let points: [Point] = [
        ...
        .init(title: "No sign-in",
              body: "As Told never asks you to create an account or sign in. Nothing ties your notes to an identity."),
        .init(title: "Voice is transcribed, not kept",
              body: "When you speak a note, the audio is sent only to transcribe it, and the recording is deleted right after. Your speech is transcribed in your own words. Punctuation is added so it reads naturally — nothing is translated, summarized, or rewritten."),
